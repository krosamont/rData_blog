...
description : "Avoid loops that stop mid-way by using `safety()` and `possibly()` from purrr... and not using loops in the first place. Let me show you what I mean through examples."
weight: 1
---
